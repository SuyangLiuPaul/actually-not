...
「其实不是」是一个中文静态站点，收录 71 条**听起来天经地义、但证据并不支持**的生活常识
...
- **内容全在一个 `myths.ts` 里，没有用 CMS / markdown / 数据库。**
  71 条纯文本，一个文件最好改、好搜索、好做 diff review，也让测试能静态检查全部内容。
...
- 71 条内容，6 个分类（吃 21 / 身体 16 / 生活 10 / 关键时刻 8 / 运动 9 / 睡 7）
- 其中 23 条标记为「可能有害」
